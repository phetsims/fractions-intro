...
<a href="https://phet.colorado.edu/sims/html/fractions-intro/latest/fractions-intro_en.html" target="_blank">Click here
to run "Fractions: Intro".</a>
...
(5) Open in the browser: `http://localhost/fractions-intro/fractions-intro_en.html` (You will probably need to modify
