Fractions: Intro
=============
"Fractions: Intro" is an educational simulation in HTML5, by <a href="https://phet.colorado.edu/" target="_blank">PhET
...
<a href="https://phet.colorado.edu/sims/html/fractions-intro/latest/fractions-intro_en.html" target="_blank">Click here to
run "Fractions: Intro".</a>

<a href="https://phet.colorado.edu/sims/html/fractions-intro/latest/fractions-intro_en.html" target="_blank">
<img src="https://raw.githubusercontent.com/phetsims/fractions-intro/main/assets/fractions-intro-screenshot.png" alt="Screenshot" style="width: 400px;"/>
</a>
...
(5) Open in the browser: `http://localhost/fractions-intro/fractions-intro_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/fractions-intro/build/adapted-from-phet/fractions-intro_en_adapted-from-phet.html` (You will
...
See the <a href="https://github.com/phetsims/fractions-intro/blob/main/LICENSE" target="_blank">LICENSE</a>
