...
(4) Open in the browser: `http://localhost/fractions-intro/fractions-intro_en.html`
...
(3) Open in the
browser: `http://localhost/fractions-intro/build/adapted-from-phet/fractions-intro_en_adapted-from-phet.html`
